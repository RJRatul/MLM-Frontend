        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">BeeCoin</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              The next generation AI-powered trading platform that helps you maximize your cryptocurrency investments with advanced algorithms.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/pricing" className="text-gray-400 hover:text-yellow-400 transition-colors">Pricing</Link></li>
              <li><Link href="/careers" className="text-gray-400 hover:text-yellow-400 transition-colors">Careers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/terms" className="text-gray-400 hover:text-yellow-400 transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} BeeCoin. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/cookies" className="text-gray-400 hover:text-yellow-400 text-sm transition-colors">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
